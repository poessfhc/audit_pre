    ...
    <div class="crumbs">
      ...
      <div class="cantainer">
        <el-table style="width: auto;" :data="projectList">
          ...
          <el-table-column label="系统名字" prop="projectName" width="180"></el-table-column>
          <el-table-column label="创建时间" prop="createTime" width="180"></el-table-column>
          <el-table-column label="创建人" prop="createBy" width="180"></el-table-column>
          <el-table-column label="工程实施用户" prop="userId" width="200"></el-table-column>
